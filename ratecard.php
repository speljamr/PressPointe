...
if ($editionid != "") {
	...
	if ($CurrentEditionID == $editionid) {
		...
		$bolHistoric = "True";
		$rstCurrentEdition = $objPublisher->GetEdition($editionid,$C_LongDateFormat,$C_ShortDateFormat);
		$CurrentEditionID = $arrCurrentEdition[0][Ident];
...
$strPageTitle = "Akron Bugle - Rate Card";

$objPublisher->objTemplate_API->setTemplate("public/ratecard.tpl");
