<?php
/*
 V3.80 27 Aug 2003  (c) 2000-2003 John Lim (jlim@natsoft.com.my). All rights reserved.
...
AND a.attnum > 0 AND a.atttypid = t.oid AND a.attrelid = c.oid ORDER BY a.attnum";
	...
	function DBTimeStamp($ts)
	{
		...
		return 'TO_TIMESTAMP('.adodb_date($this->fmtTimeStamp,$ts).",'YYYY-MM-DD HH24:MI:SS')";
	}
